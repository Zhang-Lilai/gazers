package org.tgo.gazerbase.common.reciever.SophonDrum;
 ...
 * 信号接收器的一种实现
 */
public final class SophonDrum implements SignalReciever {
    ...
    public void setSophon(Sophon sophon){
        this.sophon = sophon;
        this.sophon.call("You have been assigned to this SignalReciever:",this);
        this.sophon.call("Separator is: ",SEPARATOR);
    }
     ...
     */
    public void send(){
        this.consumer.recieveMessage(this.messageBuffer.getMessage());
    }
